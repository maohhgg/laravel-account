...
Route::middleware('auth')->group(function ($router) {
    ...
    $router->get('recharge/pay/{order}','RechargeController@restartPay')->name('restartPay');
    ...
    $router->get('password', 'HomeController@passwordForm')->name('password');
    $router->post('password/update', 'Admin\UsersController@updatePassword')->name('password.save');
});


// 充值异步处理页面
Route::post('/recharge/results','ResponseController@body')->name('recharge.results');
