                ...
                <form action="{{ route('recharge.submit') }}" method="post">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="btn-group input-group mr-2" role="group" aria-label="First group"  id="recharge-data-select">
                            {{--                            <button class="btn btn-secondary recharge-btn" data-content="0.01" type="button">--}}
                            {{--                                测试--}}
                            {{--                            </button>--}}
                            @foreach($actions as $key => $value)
                                <button class="btn btn-secondary recharge-btn" data-content="{{ 5000 * (2**$key) }}" type="button">
                                    {{ $value->name }}
                                </button>
                            @endforeach
                        </div>
