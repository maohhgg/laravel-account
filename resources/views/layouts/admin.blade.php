                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            ...
                            <li>
                                <a href="#!" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:toggleFullScreen()" class="waves-effect waves-light" data-cf-modified-2f162c1ce1d9865d79bc580c-="">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="img-radius" src="{{ asset('images/avatar.jpg') }}" alt="Generic placeholder image">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{ asset('images/avatar.jpg') }}" class="img-radius" alt="User-Profile-Image">
                                        <span>John Doe</span>
